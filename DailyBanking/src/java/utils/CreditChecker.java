...
/**
 * Jersey REST client generated for REST resource:CreditTableFacadeREST
 * [entity.credittable]<br>
 * USAGE:
 * <pre>
 *       CreditChecker client = new CreditChecker();
...
public class CreditChecker {
    ...
    public CreditChecker(String username, String password) {
        this();
