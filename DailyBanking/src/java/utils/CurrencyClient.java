...
/**
 * Jersey REST client generated for REST resource:CurrencytableFacadeREST
 * [rest.currencytable]<br>
 * USAGE:
 * <pre>
...
public class CurrencyClient {
    ...
    private static final String BASE_URI = "http://localhost:19174/RESTcurrency/webresources";

    public CurrencyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("rest.currencytable");
    }
